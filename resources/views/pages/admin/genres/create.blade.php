...
@section('content')
    <div class="mb-8">
        <h1 class="text-3xl font-bold tracking-tight text-gray-900">Add Genre</h1>
        <p class="mt-2 text-sm text-gray-500">Create a new movie genre for Ruang Cinema.</p>
    </div>
    ...
    <div class="rounded-xl border border-gray-200 bg-white shadow-sm">
        <div class="flex items-center gap-4 border-b border-gray-200 px-6 py-6 sm:px-8">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">Enter a name and the slug will be generated automatically.</p>
            </div>
        </div>
        ...
        <form method="POST" action="{{ route('admin.genres.store') }}">
            ...
            <div class="flex justify-end gap-3 border-t border-gray-200 px-6 py-5 sm:px-8">
                ...
                <button type="submit" class="inline-flex items-center gap-2 rounded-lg bg-[#071426] px-4 py-2.5 text-sm font-medium text-white hover:bg-[#111f33]">
                    <x-icon name="save" size="17" /> Save Genre
                </button>
            </div>
        </form>
    </div>
