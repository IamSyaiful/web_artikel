...
<section class="bg-gray-50 py-12">
    <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6 rounded-xl border border-red-200 bg-red-50 p-5"><p class="text-sm font-semibold text-red-900">Rejection reason</p><p class="mt-1 text-sm text-red-800">{{ $movie->note }}</p></div>
